...
public class IntermediateGameScreen implements Screen {
    ...
    public IntermediateGameScreen(Game game){
        ...
        maxTubeOffset = Gdx.graphics.getHeight() / 2 - gap / 2 - Scaler.scale(100); //changed here
    ...
    public void render(float delta) {
        ...
        if (gameState == 1) {
            ...
            for (int i = 0; i < numberOfTubes; i++) {
                ...
                if ((Gdx.graphics.getHeight() / 2 + gap / 2 + tubeOffset[i]) >= Gdx.graphics.getHeight() - random.nextInt(150)) {
                    tubeUp[i] = false;
                } else if ((Gdx.graphics.getHeight() / 2 - gap / 2 + tubeOffset[i]) <= random.nextInt(150)) {
                    tubeUp[i] = true;
                }
            ...
            game.setScreen(new GameOverScreen(game, score, highscore, Constants.INTERMEDIATE, hitAudioId));
        ...
        batch.draw(ball,
                Gdx.graphics.getWidth() / 3 - Scaler.scale(ball.getWidth()) / 2,
                birdY,
